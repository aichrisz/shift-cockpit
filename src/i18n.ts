...
const de: Record<MessageKey, string> = {
  ...
  whatsNew1: 'Calm Hotel Ledger: warmes Papier, klare Arbeitsfläche',
  whatsNew2: 'Übergabeliste mit kompakten, mobilen Aktionsreihen',
  whatsNew3: 'Editor mit klarer Kern- und Nebeninformationen-Hierarchie',
  whatsNew4: 'Settings und Export im einheitlichen Ledger-Stil',
  whatsNew5: 'Mobile Toolbar- und Panel-Aktionen umbrechen ohne Überlauf',
  open: 'Öffnen',
...
const en: Record<MessageKey, string> = {
  ...
  appVersion: 'Version {v}',
  whatsNew: "What's new",
  whatsNew1: 'Calm Hotel Ledger: warm paper and a focused workspace',
  whatsNew2: 'Handover list with compact, mobile action rows',
  whatsNew3: 'Editor hierarchy for core and optional handover details',
  whatsNew4: 'Settings and Export in one consistent ledger style',
  whatsNew5: 'Mobile toolbar and panel actions wrap without overflow',
  open: 'Open',
...
const id: Record<MessageKey, string> = {
  ...
  appVersion: 'Versi {v}',
  whatsNew: 'Yang baru',
  whatsNew1: 'Calm Hotel Ledger: kertas hangat dan ruang kerja yang fokus',
  whatsNew2: 'Daftar serah terima dengan baris aksi ringkas untuk mobile',
  whatsNew3: 'Hierarki editor untuk detail inti dan opsional',
  whatsNew4: 'Pengaturan dan Ekspor dalam gaya ledger yang konsisten',
  whatsNew5: 'Aksi toolbar dan panel mobile membungkus tanpa overflow',
  open: 'Buka',
